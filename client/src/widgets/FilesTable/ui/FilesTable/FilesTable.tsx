...
import cls from './FilesTable.module.scss';
...
export const FilesTable: FC<FilesTableProps> = memo(
    (props: FilesTableProps) => {
        const {
            className, parentId, onFileClick, onBackClick,
        } = props;
        const dispatch = useAppDispatch();
        const { data, isLoading } = useFilesTable(
            { parentId },
